...
<form method = "post" action = "recipe_modify_action.php" enctype="multipart/form-data">
				<br><table style="border-collapse: collapse;">
          <thead>
            <tr>
              <th colspan="2"><h2>레시피글 수정하기</h2></th>
            </tr>
          </thead>
          <tbody>
            <tr>
...
<button type="submit" class="big-button">저장</button></div>
      </form>
    </div>
  </div>
<footer>
